...
RSpec.describe 'Posts', type: :request do
  describe 'GET /index' do
    ...
    it 'Should check if action rendered a correct template' do
      expect(response).to render_template('index')
    end

    it 'Should check if correct placeholder text is shown' do
  ...
  describe 'GET /show' do
    ...
    it 'Should check if action returns a correct response status' do
      expect(response).to have_http_status(:ok)
    end
